...
// Fungsi untuk mengatur sesi dan cookie "Remember Me"
function set_login_session($koneksi, $id, $email, $role, $username = null, $remember_me = false)
{
    ...
    // 2. Jika "Ingat Saya" dicentang
    if ($remember_me) {
        // Hapus token lama milik user ini untuk mencegah penumpukan
        ...
        // Atur cookie di browser
        // Gabungkan selector dan validator untuk cookie
